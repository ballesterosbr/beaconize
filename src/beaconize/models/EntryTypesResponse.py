...
#   filename:  https://raw.githubusercontent.com/ga4gh-beacon/beacon-v2/refs/heads/main/framework/json/responses/beaconEntryTypesResponse.json
#   timestamp: 2026-04-21T12:22:49+00:00
...
class EntryTypes(RootModel[Any]):
    root: Any = Field(
        ...,
...
class EntryTypesSchema(BaseModel):
    ...
    entryTypes: EntryTypes = Field(..., description='List of entry types.')
...
class Model(BaseModel):
    ...
    response: EntryTypesSchema = Field(

...
#   timestamp: 2026-04-21T11:43:15+00:00
...
class GenomicFeature(BaseModel):
    ...
    featureID: Optional[OntologyTerm] = Field(
        None,
...
class Identifiers(BaseModel):
    clinvarVariantId: Optional[constr(pattern=r'^(clinvar:)?\d+$')] = Field(
        None,
    ...
    genomicHGVSId: Optional[str] = Field(
        None, description='HGVSId descriptor.', examples=['NC_000017.11:g.43057063G>A']
    )
    proteinHGVSIds: Optional[List[str]] = Field(
        None,
    ...
    transcriptHGVSIds: Optional[List[str]] = Field(
        None,
        description='List of HGVSId descriptor(s) at transcript level.',
        examples=[['NC 000023.10(NM004006.2):c.357+1G']],
    )
    variantAlternativeIds: Optional[List[ExternalReference]] = Field(
        None,
...
class PhenoClinicEffect(BaseModel):
    ...
    category: Optional[OntologyTerm] = Field(
        None,
    ...
    clinicalRelevance: Optional[ClinicalRelevance] = Field(
        None,
    ...
    evidenceType: Optional[OntologyTerm] = Field(
        None,
...
class VariantLevelData(BaseModel):
    clinicalInterpretations: Optional[List[PhenoClinicEffect]] = None
    phenotypicEffects: Optional[List[PhenoClinicEffect]] = None
...
class CaseLevelVariant(BaseModel):
    alleleOrigin: Optional[OntologyTerm] = Field(
        None,
    ...
    zygosity: Optional[OntologyTerm] = Field(
        None,
...
class Allele(BaseModel):
    ...
    location: Union[CURIE, ChromosomeLocation, SequenceLocation] = Field(
...
class Location(RootModel[Union[ChromosomeLocation, SequenceLocation]]):
...
class LegacyVariation(BaseModel):
    ...
    location: Location
    referenceBases: Optional[constr(pattern=r'^([ACGTUNRYSWKMBDHV\-\.]*)$')] = Field(
        None,
...
class MolecularVariation(RootModel[Union[Allele, Haplotype]]):
...
class SystemicVariation(RootModel[Union[CopyNumberChange, CopyNumberCount, Genotype]]):
...
class GenomicVariation(BaseModel):
    ...
    caseLevelData: Optional[List[CaseLevelVariant]] = Field(
        None,
        description='caseLevelData reports about the variation instances observed in individual analyses.',
    )
    frequencyInPopulations: Optional[List[FrequencyInPopulations]] = None
    ...
    variation: Union[MolecularVariation, SystemicVariation, LegacyVariation]
...
class UtilityVariation(RootModel[Union[Text, VariationSet]]):

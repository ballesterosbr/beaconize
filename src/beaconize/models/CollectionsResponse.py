...
#   filename:  https://raw.githubusercontent.com/ga4gh-beacon/beacon-v2/refs/heads/main/framework/json/responses/beaconCollectionsResponse.json
#   timestamp: 2026-04-21T12:38:16+00:00
...
class Response(BaseModel):
    ...
    collections: List[Dict[str, Any]] = Field(..., min_length=0)
...
class BeaconSummaryResponseSection(BaseModel):
    exists: Exists
    numTotalResults: Optional[NumTotalResults] = None
...
class BeaconReceivedRequestSummary(BaseModel):
    ...
    testMode: Optional[TestMode] = Field(
        False,
...
class BeaconResponseMeta(BaseModel):
    ...
    returnedGranularity: Granularity = Field(
        ...,
    ...
    returnedSchemas: ListOfSchemas = Field(
        ...,
    ...
    testMode: Optional[TestMode] = False
...
class Model(BaseModel):
    ...
    beaconHandovers: Optional[ListOfHandovers] = Field(
        None,
    ...
    responseSummary: BeaconSummaryResponseSection = Field(
        ...,

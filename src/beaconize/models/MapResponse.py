...
#   filename:  https://raw.githubusercontent.com/ga4gh-beacon/beacon-v2/refs/heads/main/framework/json/responses/beaconMapResponse.json
#   timestamp: 2026-04-21T12:08:55+00:00
...
class Endpoint(BaseModel):
    endpoints: Optional[Dict[str, RelatedEndpoint]] = Field(
        None,
    ...
    entryType: str = Field(..., description='')
    openAPIEndpointsDefinition: Optional[str] = Field(
        None,
    ...
    singleEntryUrl: Optional[str] = Field(
        None,
...
class BeaconMapSchema(BaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    field_schema: FieldSchema = Field(..., alias='$schema')
    endpointSets: Dict[str, Endpoint] = Field(
        ...,
...
class Model(BaseModel):
    ...
    response: BeaconMapSchema = Field(..., description='Returning the Beacon Map.')

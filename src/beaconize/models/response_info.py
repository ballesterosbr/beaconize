...
#   filename:  https://raw.githubusercontent.com/ga4gh-beacon/beacon-v2/refs/heads/main/framework/json/responses/beaconInfoResponse.json
#   timestamp: 2026-04-21T11:43:18+00:00
...
class BeaconOrganization(BaseModel):
    ...
    info: Optional[Info] = Field(
        None, description='Additional unspecified metadata about the host Organization.'
    )
    ...
    welcomeUrl: Optional[str] = Field(
        None, description='URL of the website of the organization (RFC 3986 format).'
    )
...
class BeaconInfoResults(BaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    alternativeUrl: Optional[str] = Field(
        None,
        description='Alternative URL to the API, e.g. a restricted version of this Beacon (RFC 3986 format).',
        examples=['https://example.org/beacon/authenticated'],
    )
    apiVersion: ApiVersion
    createDateTime: Optional[str] = Field(
        None,
        description='The date/time the Beacon was created (ISO 8601 format).',
        examples=['2014-07-19', '2017-01-17 20:33:40+00:00'],
    )
    description: Optional[str] = Field(None, description='Description of the Beacon.')
    ...
    id: BeaconId
    info: Optional[Info] = Field(
        None, description='Additional unspecified metadata about the Beacon service.'
    )
    name: str = Field(..., description='Name of the Beacon.')
    organization: BeaconOrganization
    updateDateTime: Optional[str] = Field(
        None,
        description='The time the Beacon was updated in (ISO 8601 format).',
        examples=['2014-07-19', '2017-01-17 20:33:40+00:00'],
    )
    version: Optional[ApiVersion] = Field(
        None, description='TODO: This is a legacy use / duplication?'
    )
    welcomeUrl: Optional[str] = Field(
        None,
...
class Model(BaseModel):
    ...
    response: BeaconInfoResults = Field(

...
#   timestamp: 2026-04-21T11:43:11+00:00
...
class DataUseConditions(BaseModel):
    ...
    duoDataUse: Optional[List[DUODataUse]] = Field(None, min_length=1)
...
class Model(BaseModel):
    ...
    createDateTime: Optional[Timestamp] = Field(
        None,
        description='The time the dataset was created (ISO 8601 format)',
        examples=['2017-01-17T20:33:40Z'],
    )
    dataUseConditions: Optional[DataUseConditions] = Field(
    ...
    updateDateTime: Optional[Timestamp] = Field(
        None,
